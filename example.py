...
parser.add_argument('data', metavar='DIR', nargs='?', 
                    default='/data/bitahub/Tiny-ImageNet',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dummy:
        ...
        train_dataset = TinyImageNet(args.data, transform=transform_train, train=True)
        val_dataset = TinyImageNet(args.data, transform=transform_test, train=False)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 5 == 0:
            torch.save(model.state_dict(), os.path.join('/output', 'model_{}.pth'.format(epoch)))
